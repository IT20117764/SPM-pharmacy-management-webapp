...
function ViewPharmacyOrders() {
    ...
    useEffect(()=> {
        ...
        if(isLogged){
            ...
            RestService.findPharmacyOrders(token,requestDto).then((res)=>{
    ...
    function generateReport() {
        ...
        doc.text("Order Report", 15, 10);
        
        autoTable(doc, { html: '#order-tbl' })
    ...
    return ( 
        <div>
            ...
            <div className="p-5">
                ...
                <table className="table table-hover table-light mb-5 mt-3" id='order-tbl'>
                    <thead>
                        <tr>
                            <th scope="col">ID</th>
...
export default ViewPharmacyOrders;